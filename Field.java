...
public class Field
{
     ...
     * @param terrainGenerator The TerrainGenerator object of the simulation
     */
    public Field(int depth, int width, TerrainGenerator terrainGenerator)
    {
        this.depth = depth;
        this.width = width;
                ...
                if(nextRow >= 0 && nextRow < depth) {
                    for(int coffset = -1; coffset <= 1; coffset++) {
                        ...
                        if(nextCol >= 0 && nextCol < width && (roffset != 0 || coffset != 0)) {                            
                            locations.add(terrainGenerator.getLocation(nextRow, nextCol));                            
                        }
                    }
                }
            }
